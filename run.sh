...
wget http://${HOST_IP}:8000/print_params_4x4 -O print_params_4x4 
wget http://${HOST_IP}:8000/print_params_8x8 -O print_params_8x8
wget http://${HOST_IP}:8000/print_params_16x16 -O print_params_16x16
